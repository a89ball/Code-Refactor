...
I completed the task by making sure that all the images had their alt tags on the ready to ensure accessability standards were met. I ensured the code was easy to comprehend on the users viewport. For the code, I implimented semantic HTML so that the code was much easier to comprehend.
